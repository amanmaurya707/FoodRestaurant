  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mx-auto">
     <li class="nav-item mr-5">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/">Back To Home</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/AboutUs">Profile</a>
      </li>
      <!--  -->
      
      
       <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/Services">Cart</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/ContactUs">Status</a>
      </li>
...
<div class="container">
    ...
    <li class=""><a href="#" style="text-decoration: none;">View Profile</a></li>
    <li class=""><a href="#" style="text-decoration: none;">Update Profile</a></li>
    </ol>
	</div>
