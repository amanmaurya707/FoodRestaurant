  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mx-auto">
     <li class="nav-item mr-5">
      <p class="my-auto" style="font-size:20px;color:black;font-family: cursive;margin-left:0px;">Admin Login</p>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/AdminProfile">Profile</a>
      </li>
      <!--  -->
      
      
       <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/ManageStock">Manage Stock</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/ManageOrder">Manage Orders</a>
      </li>
     <li class="nav-item">
        <a class="nav-link" href="/FoodRestaurant/ManageSales">Manage Sales</a>
      </li>
      <li class="nav-item">
