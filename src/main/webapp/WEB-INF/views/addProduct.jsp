...
<h1 style="color:black;font-size:25px;text-align:center;">Add  Product</h1>
...
<form:input path="productName" placeholder=" enter product name" class="form-control"/>
</div>
<div class="col-6 col-lg-6 col-md-6 col-sm-12 form-group">
...
<br>
<div class="col-6 col-lg-6 col-md-6 col-sm-12 form-group">
<form:input path="category" placeholder=" enter product category" class="form-control"/>
</div>
<div class="col-6 col-lg-6 col-md-6 col-sm-12  form-group">
...
<br>
<div class="col-6 col-lg-6 col-md-6 col-sm-12 form-group">
<form:textarea path="description" placeholder=" enter product description" class="form-control"/>
</div>
<div class="col-6 col-lg-6 col-md-6 col-sm-12 form-group">
